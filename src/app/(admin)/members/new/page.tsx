  ...
  return (
    <div className="p-3 w-full px-28 py-16">
      ...
      >
        ...
        />
        <InputField placeholder="Phone number" label="Phone number" name="contact" />
        <InputField placeholder="Enter unit name" label="Unit name" name="unit_name" />
        <InputField placeholder="Email" label="Email" type="email" name="email" />
        <InputField placeholder="Enter member id" label="Member id" name="member_id" />
        <InputField placeholder="Enter occupation" label="Occupation" name="occupation" />
